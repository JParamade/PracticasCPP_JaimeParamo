...
unsigned int fileFuncs::CheckStringCount(char* _pBuffer, unsigned int _uSize, const char* _sString) {
...
unsigned int fileFuncs::GetIntegerSum(char* _pBuffer, unsigned int _uSize) {
	unsigned int uSum = 0;
